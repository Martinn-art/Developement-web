<ul class="py-2">
            ...
            <div  class="flex items-center bg-zinc-200 hover:bg-green-600">
                 ...
                 <li>
                    <form action = "{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="bg-zinc-200 hover:bg-green-600"> <strong>Opravdu Odhlásit? Jestli jo tak si klikni</strong></button>
