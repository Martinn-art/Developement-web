<div>
    ...
    <div>
        ...
        <div class="flex flex-row">
         ...
         <aside class="bg-green-300 lg:h-auto max-w-xs">
            ...
            <div class="hover:bg-green-600">
                <a href="../../dashboardForm">
                    ...
                    <div class="flex items-center">
                             ...
                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-1"><path d="M11 14h1v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M8 2v4"/><rect x="3" y="4" width="18" height="18" rx="2"/></svg>

                         <li>
                            <strong class="mt-1 block text-lg leading-tight font-medium">Zadat rezervaci na termín vydání povolenky</strong>
                        </li>
                    </div>
                </a>
            </div>
                     ...
                     <div  class="flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar-x"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="m14 14-4 4"/><path d="m10 14 4 4"/></svg>
                         ...
                         <li>
                            ...
                            <strong class="mt-1 block text-lg leading-tight font-medium">Uložené evidované rezervace</strong>
                ...
                <a href="https://rybarizruc.webnode.cz/ceny-povolenek/">
                    ...
                    <div  class="flex items-center">
                        ...
                        <li>
                             ...
                             <strong class="mt-1 block text-lg leading-tight font-medium">Nabídka povolenek k lovu ryb</strong>
                 ...
                 <a href="https://rybariusti.cz/clanky/jak-se-prihlasit-do-ris-a-uhradit-clenske-prispevky-online#:~:text=N%C3%AD%C5%BEe%20naleznete%20stru%C4%8Dn%C3%BD%20n%C3%A1vod%2C%20jak%20se%20do%20syst%C3%A9mu,se%20p%C5%99ihl%C3%A1sit%3F%20Klikn%C4%9Bte%20na%20%22%20Vytvo%C5%99it%20%C3%BA%C4%8Det%20%22.">
                     ...
                     <div  class="flex items-center">
                         ...
                         <li>
                            ...
                            <strong class="mt-1 block text-lg leading-tight font-medium">Návod jak si vytvořit profil v RIS (rybářský informační systém)</strong>
                    ...
                    <div  class="flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pickaxe"><path d="M14.531 12.469 6.619 20.38a1 1 0 1 1-3-3l7.912-7.912"/><path d="M15.686 4.314A12.5 12.5 0 0 0 5.461 2.958 1 1 0 0 0 5.58 4.71a22 22 0 0 1 6.318 3.393"/><path d="M17.7 3.7a1 1 0 0 0-1.4 0l-4.6 4.6a1 1 0 0 0 0 1.4l2.6 2.6a1 1 0 0 0 1.4 0l4.6-4.6a1 1 0 0 0 0-1.4z"/><path d="M19.686 8.314a12.501 12.501 0 0 1 1.356 10.225 1 1 0 0 1-1.751-.119 22 22 0 0 0-3.393-6.319"/></svg>
                         ...
                         <li>
                             ...
                             <strong class="text-red-600">Zobrazit všechna data registrovaných uživatelů</strong>
